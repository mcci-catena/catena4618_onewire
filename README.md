...
This sketch demonstrates the MCCI Catena&reg; 4618 as a remote temperature/humidity/light sensor using a LoRaWAN&reg;-techology network to transmit to a remote server. It also supports the MCCI Model 4901 and similar OneWire temperature sensor.
...
Refer to the [Protocol Description](../extra/catena-message-port6-format.md) in the `extras` directory for information on how data is encoded.
